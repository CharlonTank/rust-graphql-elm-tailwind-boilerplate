...
var $author$project$Main$TokenLoaded = function (a) {
	return {$: 'TokenLoaded', a: a};
};
...
var $author$project$Main$GotUserResponse = function (a) {
	return {$: 'GotUserResponse', a: a};
};
var $author$project$Main$User = F3(
	function (id, username, isAdmin) {
		return {id: id, isAdmin: isAdmin, username: username};
	});
...
var $author$project$Api$Object$User$id = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'id', _List_Nil, $elm$json$Json$Decode$string);
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Api$Object$User$isAdmin = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Bool', 'isAdmin', _List_Nil, $elm$json$Json$Decode$bool);
...
var $author$project$Api$Object$User$username = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'username', _List_Nil, $elm$json$Json$Decode$string);
...
var $author$project$Api$Object$UserQueries$users = function (object____) {
	return A4(
...
var $author$project$Api$Query$users = function (object____) {
	return A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField, 'users', _List_Nil, object____, $elm$core$Basics$identity);
};
...
var $author$project$Main$makeUserRequest = function (token) {
	var userSelection = A4($dillonkearns$elm_graphql$Graphql$SelectionSet$map3, $author$project$Main$User, $author$project$Api$Object$User$id, $author$project$Api$Object$User$username, $author$project$Api$Object$User$isAdmin);
	var query = $author$project$Api$Query$users(
		A2(
			$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
			$author$project$Api$Object$UserQueries$users(userSelection),
			$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed(
				function (users) {
					return users;
				})));
	return A2(
		$dillonkearns$elm_graphql$Graphql$Http$send,
		A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$GotUserResponse),
		function () {
			if (token.$ === 'Just') {
				var t = token.a;
				return A2($dillonkearns$elm_graphql$Graphql$Http$withHeader, 'Authorization', 'Bearer ' + t);
			} else {
				return $elm$core$Basics$identity;
			}
		}()(
			A2($dillonkearns$elm_graphql$Graphql$Http$queryRequest, 'http://localhost:8080/graphql', query)));
};
var $author$project$Main$init = function (maybeToken) {
	return _Utils_Tuple2(
		{authError: $elm$core$Maybe$Nothing, inputAge: $elm$core$Maybe$Nothing, password: '', token: maybeToken, user: $krisajenkins$remotedata$RemoteData$NotAsked, username: ''},
		function () {
			if (maybeToken.$ === 'Just') {
				var token = maybeToken.a;
				return $author$project$Main$makeUserRequest(
...
var $author$project$Main$onTokenLoad = _Platform_incomingPort(
	'onTokenLoad',
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
	...
	if (error.$ === 'GraphqlError') {
		...
		switch (httpError.$) {
			...
			case 'BadStatus':
				...
				return 'Bad status: ' + $elm$core$String$fromInt(metadata.statusCode);
			default:
...
var $author$project$Api$InputObject$encodeLoginInput = function (input____) {
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'username',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input____.username))),
				_Utils_Tuple2(
				'password',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input____.password)))
			]));
};
...
var $author$project$Api$Object$UserMutations$login = function (requiredArgs____) {
	return A4(
		...
		_List_fromArray(
			[
				A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'input', requiredArgs____.input, $author$project$Api$InputObject$encodeLoginInput)
			]),
		$elm$json$Json$Decode$string);
};
...
var $author$project$Api$Mutation$users = function (object____) {
	return A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField, 'users', _List_Nil, object____, $elm$core$Basics$identity);
};
var $author$project$Main$makeLoginRequest = function (model) {
	var loginMutation = $author$project$Api$Mutation$users(
		A2(
			$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
			$author$project$Api$Object$UserMutations$login(
				{
					input: {password: model.password, username: model.username}
				}),
			$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed(
				function (login) {
					return login;
	...
	return A2(
		$dillonkearns$elm_graphql$Graphql$Http$send,
		A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$GotLoginResponse),
		A2($dillonkearns$elm_graphql$Graphql$Http$mutationRequest, 'http://localhost:8080/graphql', loginMutation));
};
var $author$project$Main$GotSignupResponse = function (a) {
	return {$: 'GotSignupResponse', a: a};
};
var $author$project$Api$InputObject$encodeSignupInput = function (input____) {
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Api$Object$UserMutations$signup = function (requiredArgs____) {
	return A4(
		$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
		'String',
		'signup',
		_List_fromArray(
			[
				A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'input', requiredArgs____.input, $author$project$Api$InputObject$encodeSignupInput)
			]),
		$elm$json$Json$Decode$string);
};
var $author$project$Main$makeSignupRequest = function (model) {
	var signupMutation = $author$project$Api$Mutation$users(
		A2(
			$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
			$author$project$Api$Object$UserMutations$signup(
				{
					input: {password: model.password, username: model.username}
				}),
			$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed(
	...
	return A2(
		$dillonkearns$elm_graphql$Graphql$Http$send,
		A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$GotSignupResponse),
		A2($dillonkearns$elm_graphql$Graphql$Http$mutationRequest, 'http://localhost:8080/graphql', signupMutation));
};
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Main$removeToken = _Platform_outgoingPort(
	'removeToken',
	function ($) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'AttemptSignup':
				return _Utils_Tuple2(
					model,
					$author$project$Main$makeSignupRequest(model));
			case 'AttemptLogin':
				return _Utils_Tuple2(
					model,
					$author$project$Main$makeLoginRequest(model));
			case 'GotSignupResponse':
				var response = msg.a;
				switch (response.$) {
					case 'Success':
						var token = response.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
							...
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										$author$project$Main$makeUserRequest(
										$elm$core$Maybe$Just(token))
									])));
					case 'Failure':
						var err = response.a;
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{authError: $elm$core$Maybe$Nothing, token: $elm$core$Maybe$Nothing, user: $krisajenkins$remotedata$RemoteData$NotAsked}),
					$author$project$Main$removeToken(_Utils_Tuple0));
		}
	});
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $elm$html$Html$nav = _VirtualDom_node('nav');
var $author$project$Main$Logout = {$: 'Logout'};
var $author$project$Main$viewAuthButton = function (model) {
	var _v0 = model.token;
	if (_v0.$ === 'Just') {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$class('bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-lg text-sm')
				]),
			_List_fromArray(
				[
...
var $author$project$Main$viewAuthenticated = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-3xl font-bold mb-8')
					]),
				_List_fromArray(
					[
				...
				switch (_v0.$) {
					case 'Success':
						var users = _v0.a;
						var _v1 = $elm$core$List$head(users);
						if (_v1.$ === 'Just') {
							var user = _v1.a;
							return A2(
								$elm$html$Html$p,
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Logged in as ' + user.username)
									]));
						} else {
							return $elm$html$Html$text('');
						}
					...
					case 'Failure':
						...
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-lg text-red-600')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(
...
var $author$project$Main$featureCard = F2(
	function (title, description) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('bg-white rounded-lg shadow-md p-6')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Main$AttemptSignup = {$: 'AttemptSignup'};
...
var $author$project$Main$viewAuthError = function (maybeError) {
	if (maybeError.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4')
				]),
			_List_fromArray(
				[
...
var $author$project$Main$viewLogin = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('max-w-md mx-auto bg-white rounded-lg shadow-md p-8')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-2xl font-bold mb-6')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Authentication Demo')
					])),
				$author$project$Main$viewAuthError(model.authError),
				A2(
				$elm$html$Html$form,
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500')
									]),
								_List_Nil)
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Main$AttemptSignup),
										$elm$html$Html$Attributes$class('flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg')
									]),
								_List_fromArray(
									[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-5xl font-bold text-gray-900 mb-4')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Full-Stack Boilerplate')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('A modern stack featuring Rust, GraphQL, Elm, and Tailwind CSS')
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('grid grid-cols-1 md:grid-cols-3 gap-8 mb-12')
					]),
				_List_fromArray(
					[
						A2($author$project$Main$featureCard, 'Type-Safe Backend', 'Rust backend with GraphQL API for robust and reliable server-side operations.'),
						A2($author$project$Main$featureCard, 'Modern Frontend', 'Elm for type-safe frontend development with elegant architecture.'),
						A2($author$project$Main$featureCard, 'Beautiful UI', 'Tailwind CSS for rapid and responsive design implementation.')
					])),
...
var $author$project$Main$viewContent = function (model) {
	var _v0 = model.token;
	if (_v0.$ === 'Just') {
		return $author$project$Main$viewAuthenticated(model);
	} else {
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('min-h-screen bg-gradient-to-b from-gray-50 to-gray-100')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('container mx-auto px-4 py-4')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Rust + GraphQL + Elm + Tailwind')
											])),
										$author$project$Main$viewAuthButton(model)
									]))
							]))
					])),
				A2(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		subscriptions: function (_v0) {
			return $author$project$Main$onTokenLoad($author$project$Main$TokenLoaded);
		},
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				$elm$json$Json$Decode$null($elm$core$Maybe$Nothing),
				A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $elm$json$Json$Decode$string)
			])))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Graphql.Http.Error":{"args":["parsedData"],"type":"Graphql.Http.RawError parsedData Graphql.Http.HttpError"},"Main.User":{"args":[],"type":"{ id : String.String, username : String.String, isAdmin : Basics.Bool }"},"Graphql.Http.GraphqlError.GraphqlError":{"args":[],"type":"{ message : String.String, locations : Maybe.Maybe (List.List Graphql.Http.GraphqlError.Location), details : Dict.Dict String.String Json.Decode.Value }"},"Graphql.Http.GraphqlError.Location":{"args":[],"type":"{ line : Basics.Int, column : Basics.Int }"},"Http.Metadata":{"args":[],"type":"{ url : String.String, statusCode : Basics.Int, statusText : String.String, headers : Dict.Dict String.String String.String }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"}},"unions":{"Main.Msg":{"args":[],"tags":{"UpdateUsername":["String.String"],"UpdatePassword":["String.String"],"AttemptSignup":[],"AttemptLogin":[],"GotSignupResponse":["RemoteData.RemoteData (Graphql.Http.Error String.String) String.String"],"GotLoginResponse":["RemoteData.RemoteData (Graphql.Http.Error String.String) String.String"],"GotUserResponse":["RemoteData.RemoteData (Graphql.Http.Error (List.List Main.User)) (List.List Main.User)"],"Logout":[],"TokenLoaded":["Maybe.Maybe String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Graphql.Http.HttpError":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Metadata","String.String"],"BadPayload":["Json.Decode.Error"]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Graphql.Http.RawError":{"args":["parsedData","httpError"],"tags":{"GraphqlError":["Graphql.Http.GraphqlError.PossiblyParsedData parsedData","List.List Graphql.Http.GraphqlError.GraphqlError"],"HttpError":["httpError"]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"String.String":{"args":[],"tags":{"String":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Json.Decode.Error":{"args":[],"tags":{"Field":["String.String","Json.Decode.Error"],"Index":["Basics.Int","Json.Decode.Error"],"OneOf":["List.List Json.Decode.Error"],"Failure":["String.String","Json.Decode.Value"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Graphql.Http.GraphqlError.PossiblyParsedData":{"args":["parsed"],"tags":{"ParsedData":["parsed"],"UnparsedData":["Json.Decode.Value"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));